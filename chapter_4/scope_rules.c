 ...
 * the variables or reserve storage for them.
 *
 ...
 * declarations to access it. (There may also be extern declarations in the
 * file containing the definition.) Array sizes must be specified with the
 ...
 * push and pop could be defined in one file, and the variables val and sp
